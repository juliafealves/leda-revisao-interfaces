...
public class RepositorioProdutoPerecivelArray {
	 ...
	 */
	private produto.ProdutoPerecivel[] produtos;
	...
	public RepositorioProdutoPerecivelArray(int size) {
		super();
		this.produtos = new produto.ProdutoPerecivel[size];
	}
	 ...
	 */
	public void inserir(produto.ProdutoPerecivel produto) {
		// TODO Implement your code here
		throw new UnsupportedOperationException("Not implemented yet!");
	}
	 ...
	 * utilizado.
	 */
	public void atualizar(produto.ProdutoPerecivel produto) {
		// TODO Implement your code here
		throw new UnsupportedOperationException("Not implemented yet!");
	}
